  ...
  <div className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <div className="md:flex md:items-end md:justify-between">
      <div className="max-w-xl">
        ...
        At our salon, we pride ourselves on providing top-notch beauty services that leave our customers feeling pampered and satisfied. 
      Don't just take our word for it – hear from the many clients who have experienced our exceptional services firsthand. 
        </p>
      </div>
